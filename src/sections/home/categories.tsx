            ...
            <div className="flex lg:flex-col gap-2">
              {[...new Set(CATEGORY_PRODUCTS.map(p => p.category))].map(cat => (
                <button
                  ...
                  className={`w-full px-4 py-2 rounded text-left transition-all font-semibold text-sm lg:text-base ${
                    cat === selected
                      ? 'bg-black text-white'
                      : isLightMode
                                ...
                                <div className="flex flex-col lg:flex-row gap-6">
                                  ...
                                  <div className="w-full lg:w-1/2 flex flex-col justify-between p-4">
                                    ...
                                    <div className="flex justify-center items-center space-x-2 mb-4 lg:hidden">
                                      <span className="font-bold">₡{prod.price.toLocaleString()}</span>
                                      <button
                                        onClick={() => {
                                          toggleWishlist(prod)
                                          hideModal()
                                        ...
                                        className={`p-2 rounded ${
                                          inWishlist ? 'bg-pink-500 text-white' : 'bg-gray-200 text-black hover:bg-gray-300'
                                        }`}
                                      >
                                      ...
                                      <button
                                        ...
                                        className={`p-2 rounded ${
                                          inCart ? 'bg-pink-500 text-white' : 'bg-gray-200 text-black hover:bg-gray-300'
                                        }`}
                                      >
                                        <FiShoppingCart />
                                      </button>
